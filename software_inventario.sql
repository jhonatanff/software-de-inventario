...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2024 a las 20:47:38
...
(56565, 'neymar', 'nike', '32322A', 44, '2024-11-04', 'Inglaterra'),
...
(2345, 'gaseosas', 'pepsi', 22, 12000, 'almacen1', 'gaseosas en buen estado ', '2024-10-21', 'almacen1'),
...
(9089, 'zapatos', 'adidas', 100, 35000, 'almacen1', 'la mejor', '2024-11-04', 'almacen1');
...
(10, 'jhonatan', '1112218103', 'Jefe de desarrollo', 'diazjhonatan1221@gmail.com', '$2y$10$LppZN.1G9qiBenj8V/jOGug88rxUIPtKwv.7fzfvhbeIiF/G3RSh6'),
(14, 'jose', '1231343424', 'futbolista', 'josediaz@gmail.com', '$2y$10$srYe2cWLt/5cM5zrdxFxFOSW/nEcOnjbh9.Dj/WRqnS7kGv8yViWW');
...
(2, 'Jhonatan', 'wswsw', 2222.00, 'imagenes/6737a19ecdb59_desktop-wallpaper-green-dragon-background-on-dark-dragon.jpg');
...
--
ALTER TABLE `ingreso_mercancia`
  MODIFY `codigo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9090;
